...
const PortfolioModal = ({ open, setOpen, handleUpdateSkills, isLoading, inputValues, handleChange, handleAddClick, handleRemoveClick, }) => {
                                ...
                                return (
                                    <Grid item xs={12} md={6}>
                                        ...
                                        <Box sx={{ marginTop: "7px" }}>
                                            <TextInput name="title" value={inputValue.title} onChange={(e) => handleChange(e, index)} className={classes.heroInput} placeholder="React web app" />
                                        </Box>
                                        <Box sx={{ marginTop: "7px" }}>
                                            <TextInput name="link" value={inputValue.link} onChange={(e) => handleChange(e, index)} className={classes.heroInput} placeholder="Ex: https://github.com/x/y" />
                                        </Box>
                                        {
