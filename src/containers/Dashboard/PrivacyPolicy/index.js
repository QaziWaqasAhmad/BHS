    ...
    <Box component="div">
      ...
      >
        <Container>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to BHS.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to BHS, accessible from{" "}
                <a
                  href="https://bhs-job-portal.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://bhs-job-portal.vercel.app/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: bhsjobportal@gmail.com</li>
          </ul>
        </Container>
      </Box>
    </Box>
